...
const GoogleMap = () => (
    ...
    <div className="w-full gap-6 overflow-hidden border border-blue-500 rounded-sm h-80">
        ...
        <iframe
            ...
            width="100%"
            height="100%"
            className="transition-opacity duration-300 rounded-sm opacity-60 hover:opacity-80"
            allowFullScreen=""
            loading="lazy"

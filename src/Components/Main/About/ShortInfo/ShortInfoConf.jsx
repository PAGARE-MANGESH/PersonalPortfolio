            ...
            {open && (
                <motion.div
                    ...
                    <motion.div
                        ref={modalRef}
                        className={cn(
                            "min-h-[50%] max-h-[90%] md:max-w-[96%] bg-[rgba(255, 255, 255, 0.1)] backdrop-blur-sm border border-blue-500 dark:border-neutral-800 md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden -mt-96",
                            className
                        )}
                        initial={{
                            opacity: 0,

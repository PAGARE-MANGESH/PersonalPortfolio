                ...
                {data.map((item, index) => (
                    <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
                        <div
                            ...
                            <h3
                                className="hidden text-xl font-bold text-blue-500 md:block md:pl-20 md:text-3xl ">
                                {item.title}
                            </h3>
                        </div>
                        ...
                        <div className="relative w-full pl-20 pr-4 md:pl-4">
                            <h3
                                className="block mb-4 text-2xl font-bold text-left text-blue-500 md:hidden">
                                {item.title}
                            </h3>
                            {item.content}{" "}
                        </div>

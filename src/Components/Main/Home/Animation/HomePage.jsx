...
export default function SparklesPreview() {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full h-auto mt-20 mb-10">

            <div className="relative grid items-end w-full grid-cols-1 gap-0 px-1 mt-1 md:grid-cols-1 sm:px-2 md:px-2 lg:px-1" data-aos="fade-up">

                <div className="relative z-10 w-full text-center md:text-left md:absolute md:pl-10" >
                    ...
                    <h1 className="text-3xl font-bold text-blue-500 md:text-4xl lg:text-6xl">
                        My Portfolio
                    </h1>
                ...
                <div className="relative flex justify-center z-1 md:ml-40" >

  ...
  return (
    <>
      ...
      {/* <div className="flex items-center justify-center w-screen h-screen ">
        <h2
          id="homeTitle"
          className="relative text-center block w-full px-10 py-6 md:px-20 md:py-8 lg:px-32 lg:py-10 text-2xl md:text-4xl lg:text-6xl font-bold text-blue-500"
        >
          <span className="inline-block transform transition-transform duration-500 ease-in-out hover:scale-110 hover:translate-y-1">
            Hey
          </span>
          <br />
          <span className="inline-block mt-4 text-blue-400 transition-opacity duration-700 ease-in-out hover:opacity-80">
            Hellopoooooo
          </span>
        </h2>
      </div> */}
